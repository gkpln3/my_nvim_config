...
if is_available "telescope.nvim" then
  ...
  maps.n["<leader>fw"] = { "<cmd>Telescope egrepify<CR>", desc = "Find words" }
  maps.n["<leader>fW"] = {
    function()
...
maps.n["<ESC>"] = { "<cmd>noh<CR>", desc = "Clear highlight" }
...
maps.n["-"] = { "<CMD>Oil<CR>", desc = "Open parent directory" }
maps.t["<C-x>"] = { "<C-\\><C-n>", desc = "Exit terminal mode" }
maps.n['<leader>S'] = {'<cmd>lua require("spectre").toggle()<CR>',
    desc = "Toggle Spectre"
}
maps.n["<leader>sw"] = { '<cmd>lua require("spectre").open_visual({select_word=true})<CR>',
    desc = "Search current word"
}
maps.v["<leader>sw"] = { function() require("spectre").open_visual() end,
    desc = "Search current word"
}
